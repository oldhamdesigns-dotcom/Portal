...
const AdvertisementIcon = ({ height = 24, width = 24, className }: IconProps) => (
  <svg
    width={width}
    height={height}
    viewBox={'0 0 16 16'}
  ...
  >
    ...
    <path
      d={'M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z'}></path>
  </svg>
);

export default memo(AdvertisementIcon);
