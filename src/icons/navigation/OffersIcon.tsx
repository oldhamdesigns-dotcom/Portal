...
const OffersIcon = ({ height = 24, width = 24, className }: IconProps) => (

  <svg xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 16 16'} width={width} height={height}
       className={cn('fill-inactive', className)}>
    <path fillRule={'evenodd'} d={'M11 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8m5-4a5 5 0 1 1-10 0 5 5 0 0 1 10 0'}></path>
    <path
    ...
    <path
      d={'M1 0a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h4.083q.088-.517.258-1H3a2 2 0 0 0-2-2V3a2 2 0 0 0 2-2h10a2 2 0 0 0 2 2v3.528c.38.34.717.728 1 1.154V1a1 1 0 0 0-1-1z'}></path>
    <path d={'M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 6 6 0 0 1 3.13-1.567'}></path>
  </svg>
);

export default memo(OffersIcon);
